          ...
          <div className='bg-[#020617] border border-gray-800 max-w-2xl w-full mx-4 rounded-xl shadow-2xl overflow-hidden'>
            ...
            <div className='px-4 sm:px-6 py-4 max-h-[70vh] overflow-y-auto text-sm leading-relaxed text-gray-300 space-y-3'>
              {openModal === 'privacy' ? (
                <>
                  <p>
                    نحترم خصوصيتك بشكل كامل، ويتم استخدام بياناتك فقط لتحسين
                    تجربة التسوّق، إتمام الطلبات، والتواصل معك بشأن العروض
                    والتحديثات.
                  </p>
                  <p>
                    لا نقوم بمشاركة بياناتك الشخصية مع أي طرف ثالث لأغراض
                    تسويقية بدون موافقتك المسبقة، ويتم تخزين البيانات في بيئة
                    آمنة قدر الإمكان.
                  </p>
                  <p>
                ...
                <>
                  ...
                  <p>
                    الأسعار، العروض، وسياسات الشحن والإرجاع قد تتغير من وقت
                    لآخر، ويقع على عاتقك مراجعة الصفحة بشكل دوري لمعرفة أي
                    تحديثات.
                  </p>
                  <p>
